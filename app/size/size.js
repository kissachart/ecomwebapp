...
ajaxHandle.push({
    ...
    handle: async function (q, res) {
        ...
        queryText = "select * from ecomwebapp.size s where s.Name ='"+q.NAME+"';"
        try {
        ...
        queryText = `insert into ecomwebapp.size (NAME) values ('`+q.NAME+`');`;
        try {
...
ajaxHandle.push({
    ...
    handle: async function (q, res) {
        ...
        queryText = "select * from ecomwebapp.size s where s.ID ='"+q.ID+"';";
        try {
        ...
        try {
            queryText = `update ecomwebapp.size set NAME = '`+q.NAME+`' where ID = `+q.ID+`;`;
...
ajaxHandle.push({
        ...
        handle: async function (q, res) {
            ...
            try {
                queryText = `delete from ecomwebapp.size where ID = `+q.ID+`;`;
...
ajaxHandle.push({
    ...
    handle: async function (q, res) {
        ...
        try {
            ...
            queryText = `select * from ecomwebapp.size `+limit;
